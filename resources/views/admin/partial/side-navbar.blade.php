     ...
     <div id="miniSidebar">
         <div class="brand-logo">
             <a class="d-none d-md-flex align-items-center gap-2" href="../index.html">
                 <img src="{{ asset('storage/admin/assets/images/brand/logo/lgo-icon.svg') }}" alt="" />
             ...
             <ul class="navbar-nav flex-column  ">
                 ...
                 <li class="nav-item dropdown">
                     ...
                     <ul class="dropdown-menu flex-column">
                         ...
                         <li class="nav-item">
                             <a class="nav-link" href="../pages/authentication/otp-varification.html">Otp Varification
                             </a>
                         </li>
                     </ul>
                 </li>
